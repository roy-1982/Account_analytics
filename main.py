...
cprint(f"{StdText('1人当たり月間売上高', Color.BRIGHT_MAGENTA)}: {(revenue / 12) / num_employees / 100000000:.4f}億円")
...
cprint(f"{StdText('EV/EBITDA倍率', Color.BRIGHT_YELLOW)}: {(market_cap + (all_debt - cash)) / (operating_income + depreciation):.2f}倍")
